...
class PellIconeController : UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    let ImageBank : [String] = ["appareil_photo", "art", "delete", "Familles", "fondInstant", "fondInstantPhoto", "info", "LogoInstantDeMesCouilles", "LogoPhoto", "newfond", "plus", "soleil", "chateau_de_sable"]
